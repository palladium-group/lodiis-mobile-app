...
class OvcHouseholdHtsAssessmentForm extends StatefulWidget {
  ...
  @override
  State<OvcHouseholdHtsAssessmentForm> createState() =>
      _OvcHouseholdHtsAssessmentFormState();
}

class _OvcHouseholdHtsAssessmentFormState
    extends State<OvcHouseholdHtsAssessmentForm> {
  final String label = 'HTS Assessment Form';
  ...
  void setFormSections() {
    mandatoryFields = [
      'eventDate',
      ...OvcHouseholdServiceHtsScreening.getMandatoryFields()
    ];
    OvcHousehold? household =
        Provider.of<OvcHouseholdCurrentSelectionState>(context, listen: false)
            .currentOvcHousehold;
    formSections = OvcHouseholdServiceHtsScreening.getFormSections(
  ...
  void clearFormAutoSaveState(
    ...
    String formAutoSaveId =
        "${OvcRoutesConstant.houseHoldHtsAssessmentFormPage}_${beneficiaryId}_$eventId";
  ...
  void onUpdateFormAutoSaveState(
    ...
    FormAutoSave formAutoSave = FormAutoSave(
      ...
      pageModule: OvcRoutesConstant.houseHoldHtsAssessmentFormPage,
      nextPageModule: isSaveForm
          ? nextPageModule != ""
          ? nextPageModule
          : OvcRoutesConstant.houseHoldHtsAssessmentFormNextPage
          : OvcRoutesConstant.houseHoldHtsAssessmentFormPage,
    ...
    if (hadAllMandatoryFilled) {
      ...
      try {
        await TrackedEntityInstanceUtil.savingTrackedEntityInstanceEventData(
          OvcHouseholdHtsAssessmentConstant.program,
          OvcHouseholdHtsAssessmentConstant.programStage,
          orgUnit,
          formSections!,
          dataObject,
          eventDate,
