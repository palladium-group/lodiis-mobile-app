...
import 'package:kb_mobile_app/modules/ovc_intervention/submodules/ovc_services/ovc_services_pages/household_monitor/skip_logics/ovc_household_monitoring_skip_logic_test.dart';
...
class OvcHouseholdMornitoringForm extends StatefulWidget {
  const OvcHouseholdMornitoringForm({Key? key}) : super(key: key);

  @override
  State<OvcHouseholdMornitoringForm> createState() =>
      _OvcHouseholdMornitoringFormState();
}
...
class _OvcHouseholdMornitoringFormState
  ...
  void setFormSections() {
    mandatoryFields = [
      'eventDate',
      ...OvcHouseholdOngoingMonitoring.getMandatoryFields()
    ];
    OvcHousehold? household =
        Provider.of<OvcHouseholdCurrentSelectionState>(context, listen: false)
            .currentOvcHousehold;
    formSections = OvcHouseholdOngoingMonitoring.getFormSections(
