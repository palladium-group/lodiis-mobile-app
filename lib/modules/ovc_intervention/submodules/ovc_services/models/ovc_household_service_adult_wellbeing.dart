    ...
    return [
      ...
      FormSection(
          ...
          inputFields: [
            InputField(
                id: 'income_source',
                translatedName: '1. U fumana chelete joang?',
                name: '1. What is your source of income?',
                valueType: 'CHECK_BOX',
            ...
            InputField(
                id: 'time_for_visit',
                translatedName: '2. Nako e nepahetseng hore re etele lelapa?',
                name: '2. Appropriate time for us to visit your home?',
                valueType: 'CHECK_BOX',
                inputColor: const Color(0xFF4B9F46),
                labelColor: const Color(0xFF1A3518),
                options: [
            ...
            InputField(
              id: 'PpghWNFLAF3',
              name: '3. As a family, where do you access health services?',
              translatedName:
              "3. Lele lelapa le fumana litsebeletso tsa bophelo hokae?",
            ...
            InputField(
                id: 'ut8LqpHyZnR',
                name:
                    '4. Do you or anyone have a long-term illness that you would like to share with me',
                translatedName:
                    '4. Na oena kapa emong oa ba lelapa o na le bokulo ba nako e telele bo u ka lakatsang ho mpolella bona?',
                valueType: 'BOOLEAN',
                inputColor: const Color(0xFF4B9F46),
                labelColor: const Color(0xFF1A3518)),
            InputField(
            ...
            InputField(
                ...
                name: '5. What is the long-term illness that you have?',
                translatedName:
                    '5. Ke bokuli bo fe ba nako e telele boo u nang le bona?',
                valueType: 'CHECK_BOX',
                inputColor: const Color(0xFF4B9F46),
                labelColor: const Color(0xFF1A3518),
                options: [
            ...
            InputField(
                id: 'AccHyrWqhI0',
                name: '6. Are you receiving treatment for this illness?',
                translatedName: '6. Na u fumana kalafo ea lefu leo?',
            ...
            InputField(
                id: 'ubin7MjQ5OI',
                name: '10. If Yes, How long have you been on ART?',
                valueType: 'TEXT',
                inputColor: const Color(0xFF4B9F46),
                labelColor: const Color(0xFF1A3518),
                options: [
            ...
            InputField(
                id: 'sLyfb45aLkl',
                name: '12. Have you ever had a blood test called viral load?',
                translatedName:
                    '12. U kile oa etsa hlahlobo ea mali bakeng sa boemo ba t’soaetso bo maling (viral load)?',
                description:
            ...
            InputField(
                id: 'aRNGDZcwWmS',
                name: '13. What was the result of your viral load test?',
                translatedName:
                    '13. Sephetho sa tlhahlobo eo ea mali se ne se reng?',
                description:
           ...
           InputField(
                id: 'BYZu8p33lzP',
                name: '14. Have you disclosed your status to anyone?',
                translatedName:
                    '14. Na ho na le motho eo u kileng oa mojoetsa boemo ba hau ba HIV?',
            ...
            InputField(
                id: 'ToWhhydys',
                name: '15. To whom have you disclosed your status?',
                translatedName:
                    '15. Ke mang eo u mo joetsitseng ka boemo a hao a HIV?',
                valueType: 'CHECK_BOX',
                inputColor: const Color(0xFF4B9F46),
                labelColor: const Color(0xFF1A3518),
                options: [
            ...
            InputField(
                id: 'jzmOXiyGGgw',
                name:
                    '16. Do you feel like people treat you differently because you are HIV positive?',
                translatedName:
                    '16. Na o nahana hore batho ba o khetholla hobane unale le tso’oaetso ea HIV?',
                description:
