...
import '../skip_logics/ovc_household_tb_referral.dart';

class OvcHouseholdAddTbReferralForm extends StatefulWidget {
  const OvcHouseholdAddTbReferralForm({Key? key}) : super(key: key);

  @override
  State<OvcHouseholdAddTbReferralForm> createState() =>
      _OvcHouseholdAddTbReferralFormState();
}

class _OvcHouseholdAddTbReferralFormState
    extends State<OvcHouseholdAddTbReferralForm> {
  ...
  evaluateSkipLogics() {
    Timer(
      const Duration(milliseconds: 200),
        ...
        await OvcHouseholdTbReferralSkipLogic.evaluateSkipLogics(
          context,
          formSections,
          dataObject,
        );
