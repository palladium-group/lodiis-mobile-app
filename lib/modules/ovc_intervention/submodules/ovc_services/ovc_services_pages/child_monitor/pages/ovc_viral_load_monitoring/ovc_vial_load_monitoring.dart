...
class _OvcViralLoadMonitoringState extends State<OvcViralLoadMonitoring> {
  ...
  void onAddViralLoadMonitoring(BuildContext context) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const OvcChildViralLoadMonitoringForm(),
      ),
    );
  }
          ...
          children: [
            Container(
              ...
              child: events.isEmpty
                  ? const Text(
                  'There is no Viral Load Monitoring at a moment')
                  : Column(
                children: events.map((Events event) {
                  ...
                  return Container(
                    ...
                    child: OvcChildViralLoadMonitorContainer(
                      eventData: event,
                      index: index,
                      onEditMonitor: () =>
                          onEditViralLoadMonitoring(
                              context, event),
                      onViewMonitor: () =>
                          onViewViralLoadMonitoring(
                              context, event),
                    ),
                  );
                }).toList(),
